...
export const LoginOptions = () => {
	...
	const onAvatarMetaDoubleClick = useCallback(() => setAvatarMetaKeyReadOnly(false), []);
	...
	return (
		<SectionCard title={__('Login Options')}>
			...
			<FormField
				description={__('The user meta key to be used to save Telegram photo URL.')}
				fieldType='text'
			...
			<FormField
				conditions={disableSignupConditions}
				description={
					__('If enabled, a random email address will be generated for new user accounts.') +
					' ' +
					__('Useful when you want the users to be able to receive private notifications.')
				}
				fieldType='switch'
